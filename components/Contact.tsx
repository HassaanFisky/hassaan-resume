  ...
  const socialLinks = [
    {
      icon: Github,
      name: 'GitHub',
      href: 'https://github.com/hassaanfisk',
      color: 'hover:text-gray-900 dark:hovery:text-white',
    },
    {
      icon: Linkedin,
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/https://www.linkedin.com/in/hassaan-khan-975679270/',
